...
type Url struct {
	...
	// ShortcutURL holds the value of the "shortcut_url" field.
...
func (*Url) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case url.FieldOriginURL, url.FieldShortcutURL:
	...
	for i := range columns {
		...
		case url.FieldOriginURL:
			if value, ok := values[i].(*sql.NullString); !ok {
				...
				u.OriginURL = value.String
			}
		case url.FieldShortcutURL:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field shortcut_url", values[i])
			} else if value.Valid {
				u.ShortcutURL = value.String
			}
		default:
...
func (u *Url) String() string {
	...
	builder.WriteString(u.OriginURL)
	builder.WriteString(", ")
	builder.WriteString("shortcut_url=")
	builder.WriteString(u.ShortcutURL)
	builder.WriteByte(')')
